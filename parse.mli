...
val parse_instruction : int -> string list -> (int * (string list))
                        -> instr * (int * (string list)) list
...
val parse_block : (int * (string list)) -> int
                  -> (int * instr) list * (int * (string list)) list
...
val lines_to_words : (int * string) list -> (int * (string list)) list
...
val remove_comments : (int * string) list -> (int * string) list
...
val compute_indent : (string list) -> int
...
val find_cmp_and_partition : (string list) -> comp * (string list) * (string list)
...
val next_line_is_else : (int * (string list)) list -> boolean
